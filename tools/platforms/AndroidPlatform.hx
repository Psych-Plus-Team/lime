...
class AndroidPlatform extends PlatformTarget
{
	...
	public override function update():Void
	{
		...
		context.ANDROID_GRADLE_VERSION = project.config.getString("android.gradle-version", "8.12");
		...
		context.ANDROID_ENABLE_JETIFIER = project.config.getString("android.enableJetifier", "true");
